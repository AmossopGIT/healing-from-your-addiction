...
export const seoPages = {
  home: {
    ...
    description:
      "Healing From Your Addiction offers confidential hypnotherapy and EFT-based support through a progressive package path — Free Start, monthly plans, Complete Healing and Master Plan — for addiction patterns in South Africa.",
  ...
  programmes: {
    ...
    description:
      "Compare Free Start tools, monthly hypnotherapy packages, comprehensive four-month healing and a 30-day Master Plan — then choose the addiction support page that fits.",
    primaryKeyword: "addiction healing programmes South Africa",
    secondaryKeywords: [
      "addiction healing packages South Africa",
    ...
    searchIntent: "Compare addiction healing packages and choose a support path.",
    pageType: "programme-overview",
    conversionGoal: "Move to healing packages or submit a confidential enquiry.",
    ogImage: defaultOgImage,
    ogImageAlt: "Addiction healing programme options for confidential support",
  },
  fourWeekProgram: {
    path: "/programs/4-week-addiction-healing-program/",
    title: "Master Plan Fast-Track Sessions | Healing From Your Addiction",
    description:
      "Learn how the Master Plan intensive rhythm works — about eight concentrated sessions — and compare Free Start, monthly plans and Complete Healing on the packages page.",
    primaryKeyword: "addiction healing master plan South Africa",
    secondaryKeywords: [
      "30 day addiction hypnotherapy",
      "8 session hypnotherapy program",
      "fast track addiction support",
      "addiction healing packages South Africa",
    ],
    searchIntent: "Understand the intensive Master Plan rhythm and compare other package levels.",
    pageType: "programme-overview",
    conversionGoal: "Compare healing packages or enquire about Master Plan.",
    ogImage: "/art/watercolor/art-watercolor-package-master-fast-track.png",
    ogImageAlt: "Minimal watercolor path marks suggesting intensive fast-track addiction healing sessions",
  },
  healingPackages: {
  ...
  faqs: {
    ...
    description:
      "Answers to common questions about addiction hypnotherapy, EFT, healing packages, confidentiality, medical safety and enquiries.",
    primaryKeyword: "addiction hypnotherapy FAQs",
    secondaryKeywords: ["gambling addiction FAQs", "food addiction FAQs", "hypnotherapy safety", "addiction healing packages FAQs"],
    searchIntent: "Answer trust, safety and package questions before enquiry.",
    pageType: "trust",
