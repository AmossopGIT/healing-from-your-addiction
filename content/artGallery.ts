...
export const artGallery: readonly ArtGalleryItem[] = [
  ...
  },
  {
    ...
    alt: "Minimal watercolor illustration of an open booklet beside a soft pathway mark, suggesting free tools to begin healing.",
    prompt: `${basePrompt} Show a simple open booklet with one gentle pathway mark, suggesting free tools and a first step into healing.`,
    palette: sharedPalette,
  ...
  },
  {
    ...
    alt: "Minimal watercolor illustration of one stepping stone with a soft teal wash and gold pause ring, suggesting foundation support.",
    prompt: `${basePrompt} Show one solid stepping stone with a soft teal wash and small gold pause ring, suggesting affordable foundation support.`,
    palette: sharedPalette,
  ...
  },
  {
    ...
    alt: "Minimal watercolor illustration of two connected stepping stones on a curved path, suggesting deeper personal support.",
    prompt: `${basePrompt} Show two connected stepping stones along a gentle curved path with a deeper teal wash, suggesting going deeper into healing support.`,
    palette: sharedPalette,
  ...
  },
  {
    ...
    alt: "Minimal watercolor illustration of an open folder with four pathway cards and a gold pause mark, suggesting a comprehensive healing journey.",
    prompt: `${basePrompt} Show an open folder with a structured pathway of four soft cards and one gold pause mark, suggesting a comprehensive four-month healing journey.`,
    palette: sharedPalette,
  ...
  },
  {
    ...
    alt: "Minimal watercolor illustration of eight path marks on a short concentrated arc inside a circle, suggesting intensive fast-track healing.",
    prompt: `${basePrompt} Show a short concentrated arc of eight small path marks within one month-like circle, suggesting intensive fast-track healing commitment.`,
    palette: sharedPalette,
