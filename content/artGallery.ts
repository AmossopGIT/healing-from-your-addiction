...
export const artGallery: readonly ArtGalleryItem[] = [
  ...
  {
    id: "package-free-start",
    title: "Package A - Free Start",
    category: "healing-packages",
    src: "/art/watercolor/art-watercolor-package-free-start.png",
    alt: "Minimal watercolor illustration of an open booklet with a soft teal wash and gold pause circle, suggesting free tools to begin healing.",
    prompt: `${basePrompt} Additive package series image A (base only): open booklet with soft teal wash and muted gold pause circle. Free Start — tools to begin. No other package motifs yet.`,
    palette: sharedPalette,
    usage: "Healing packages path, compare, and detail cards for Package A Free Start.",
  },
  {
    id: "package-foundation",
    title: "Package B - Foundation Plan",
    category: "healing-packages",
    src: "/art/watercolor/art-watercolor-package-foundation.png",
    alt: "Minimal watercolor illustration of an open booklet plus one foundation stepping stone under a gold pause circle, suggesting essential monthly support.",
    prompt: `${basePrompt} Additive package series image B: keep A's open booklet, teal wash, and gold pause; ADD one solid foundation stepping stone for Essential support.`,
    palette: sharedPalette,
    usage: "Healing packages path, compare, and detail cards for Package B Foundation Plan.",
  },
  {
    id: "package-transformation",
    title: "Package C - Transformation Plan",
    category: "healing-packages",
    src: "/art/watercolor/art-watercolor-package-transformation.png",
    alt: "Minimal watercolor illustration of an open booklet, foundation stone, and a second deeper stone linked by a curved path, suggesting going deeper.",
    prompt: `${basePrompt} Additive package series image C: keep A's booklet and B's foundation stone; ADD a second deeper stone with a gentle connecting path (three motifs total).`,
    palette: sharedPalette,
    usage: "Healing packages path, compare, and detail cards for Package C Transformation Plan.",
  },
  {
    id: "package-complete-healing",
    title: "Package D - Complete Healing Plan",
    category: "healing-packages",
    src: "/art/watercolor/art-watercolor-package-complete-healing.png",
    alt: "Minimal watercolor illustration of booklet, path stones, and a wooden tray of journey cards, suggesting a complete structured healing plan.",
    prompt: `${basePrompt} Additive package series image D: keep A–C motifs (booklet, foundation stone, deeper stones with path); ADD a small wooden tray of upright journey cards (four motifs total).`,
    palette: sharedPalette,
    usage: "Healing packages path, compare, and detail cards for Package D Complete Healing Plan.",
  },
  {
    id: "package-master-fast-track",
    title: "Package E - Master Plan Fast Track",
    category: "healing-packages",
    src: "/art/watercolor/art-watercolor-package-master-fast-track.png",
    alt: "Minimal watercolor illustration of booklet, path stones, journey-card tray, and a crescent moon over an intensive winding path, suggesting fast-track healing.",
    prompt: `${basePrompt} Additive package series image E: keep A–D motifs; ADD a crescent moon and a more concentrated winding stone path for intensive Fast Track (five motifs total).`,
    palette: sharedPalette,
    usage: "Healing packages path, compare, and detail cards for Package E Master Plan Fast Track.",
  },
  {
  ...
  {
    id: "blog-substance-addictions-overview",
    title: "Substance Addictions Blog - Overview",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-overview.png",
    alt: "Minimal watercolor illustration of an anonymous figure beside a stone with gentle ripple rings, suggesting the body adapting over time.",
    prompt: `${basePrompt} Create supplementary artwork for "Signs of Substance Addictions." Show an anonymous figure beside a smooth stone with two gentle ripple rings and a quiet pathway, symbolising the body adapting over time.`,
    palette: sharedPalette,
    usage: "Inline artwork for the overview section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-dependence-signs",
    title: "Substance Addictions Blog - Dependence Signs",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-dependence-signs.png",
    alt: "Minimal watercolor illustration of five stones arranged in a gentle loop with a gold pause stone, suggesting common dependence signs.",
    prompt: `${basePrompt} Create supplementary artwork for "Signs of Substance Addictions." Show five smooth stones arranged along a loose circular path with one gold pause stone and an anonymous figure observing from the side, suggesting common dependence signs without text.`,
    palette: sharedPalette,
    usage: "Inline artwork for the core physical-dependence signs section.",
  },
  {
    id: "blog-substance-addictions-alcohol-withdrawal",
    title: "Substance Addictions Blog - Alcohol Withdrawal Safety",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-alcohol-withdrawal.png",
    alt: "Minimal watercolor illustration of an unlabeled glass beside calm ripples and a gold pause point, suggesting alcohol withdrawal safety.",
    prompt: `${basePrompt} Create supplementary artwork for the alcohol withdrawal section of "Signs of Substance Addictions." Show an unlabeled glass silhouette, soft teal ripples, and a clear gold pause point. Keep safety-conscious and non-dramatic.`,
    palette: sharedPalette,
    usage: "Inline artwork for the alcohol withdrawal section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-nicotine-craving",
    title: "Substance Addictions Blog - Nicotine Craving",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-nicotine-craving.png",
    alt: "Minimal watercolor illustration of a small unbranded silhouette and vapor curl inside a gentle loop, suggesting nicotine cravings.",
    prompt: `${basePrompt} Create supplementary artwork for the nicotine section of "Signs of Substance Addictions." Show one small unbranded stick-like silhouette with a vapor curl opening into a broken loop and a gold pause point. Do not glamorise smoking.`,
    palette: sharedPalette,
    usage: "Inline artwork for the nicotine addiction section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-cannabis-dependence",
    title: "Substance Addictions Blog - Cannabis Dependence",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-cannabis-dependence.png",
    alt: "Minimal watercolor illustration of an abstract leaf inside a gentle loop with a gold pause point, suggesting cannabis dependence awareness.",
    prompt: `${basePrompt} Create supplementary artwork for the cannabis section of "Signs of Substance Addictions." Show one abstract simple leaf inside a loose teal loop with a gold pause point. Keep neutral and non-promotional.`,
    palette: sharedPalette,
    usage: "Inline artwork for the cannabis dependence section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-opioid-withdrawal",
    title: "Substance Addictions Blog - Opioid Withdrawal",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-opioid-withdrawal.png",
    alt: "Minimal watercolor illustration of a difficult winding path with smooth stones and a gold pause point, suggesting opioid withdrawal support.",
    prompt: `${basePrompt} Create supplementary artwork for the opioid section of "Signs of Substance Addictions." Show a winding path with a few heavy smooth stones and a small open space ahead, symbolising a difficult withdrawal path and the need for support. No drugs or syringes.`,
    palette: sharedPalette,
    usage: "Inline artwork for the opioid addiction section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-stimulant-crash",
    title: "Substance Addictions Blog - Stimulant Crash",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-stimulant-crash.png",
    alt: "Minimal watercolor illustration of an energetic line settling into a slower path beside an anonymous figure, suggesting stimulant crash and recovery support.",
    prompt: `${basePrompt} Create supplementary artwork for the stimulant section of "Signs of Substance Addictions." Show a loose energetic line settling into a slower curved pathway beside an anonymous figure and a gold pause point, symbolising crash, fatigue, and cravings.`,
    palette: sharedPalette,
    usage: "Inline artwork for the stimulant addiction section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-prescription-safety",
    title: "Substance Addictions Blog - Prescription Safety",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-prescription-safety.png",
    alt: "Minimal watercolor illustration of a plain closed container beside a path ending at a gold pause point, suggesting medically supervised tapering.",
    prompt: `${basePrompt} Create supplementary artwork for the prescription drug section of "Signs of Substance Addictions." Show a plain closed container beside a gently descending path that stops at a gold pause marker, symbolising medically supervised tapering. No labels or scattered pills.`,
    palette: sharedPalette,
    usage: "Inline artwork for the prescription drug addiction section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-inhalant-toxicity",
    title: "Substance Addictions Blog - Inhalant Toxicity",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-inhalant-toxicity.png",
    alt: "Minimal watercolor illustration of an abstract vapor curl moving away from a plain object, suggesting inhalant toxicity awareness.",
    prompt: `${basePrompt} Create supplementary artwork for the inhalant section of "Signs of Substance Addictions." Show a thin abstract vapor curl moving away from a small plain object silhouette toward open space, suggesting toxicity awareness without depicting inhalation.`,
    palette: sharedPalette,
    usage: "Inline artwork for the inhalant abuse section of Signs of Substance Addictions.",
  },
  {
    id: "blog-substance-addictions-safety-support",
    title: "Substance Addictions Blog - Safety and Support",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-substance-addictions-safety-support.png",
    alt: "Minimal watercolor illustration of an anonymous figure approaching a gold pause stone on a path, suggesting appropriate medical supervision for dangerous withdrawal.",
    prompt: `${basePrompt} Create supplementary artwork for the critical safety note in "Signs of Substance Addictions." Show an anonymous figure approaching a gold pause stone on a path held by two protective curved lines, symbolising stopping to seek appropriate medical supervision.`,
    palette: sharedPalette,
    usage: "Inline artwork for the critical safety section of Signs of Substance Addictions.",
  },
  {
  ...
  {
    id: "blog-sex-addiction-pattern-awareness",
    title: "Sex Addiction Blog - Pattern Awareness",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-sex-addiction-pattern-awareness.png",
    alt: "Minimal watercolor illustration of an anonymous figure beside a gentle circular path with pause points, suggesting awareness of a recurring private pattern.",
    prompt: `${basePrompt} Create supplementary artwork for the article "Sex Addiction: Recovery Through Emotional Connection." Show one anonymous figure beside a loose circular teal path with three small abstract turning points and one muted gold pause stone. Keep fully non-explicit, calm, and non-stigmatizing.`,
    palette: sharedPalette,
    usage: "Inline artwork for the pattern-awareness section of the CMS blog: Sex Addiction: Recovery Through Emotional Connection.",
  },
  {
    id: "blog-sex-addiction-pause-response",
    title: "Sex Addiction Blog - Pause Before Response",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-sex-addiction-pause-response.png",
    alt: "Minimal watercolor illustration of a hand beside an open loop and gold pause point, suggesting space between an urge and a response.",
    prompt: `${basePrompt} Create supplementary artwork for the article "Sex Addiction: Recovery Through Emotional Connection." Show a simple anonymous hand resting beside, but not touching, a loose looping line with a clear open gap and one muted gold pause dot. Let the teal wash open into quiet cream space. Keep fully non-explicit, calm, and non-stigmatizing.`,
    palette: sharedPalette,
    usage: "Inline artwork for the pause-and-response section of the CMS blog: Sex Addiction: Recovery Through Emotional Connection.",
  },
  {
    id: "blog-sex-addiction-rebuilding-connection",
    title: "Sex Addiction Blog - Rebuilding Connection",
    category: "blog-addiction-recovery",
    src: "/art/watercolor/art-watercolor-blog-sex-addiction-rebuilding-connection.png",
    alt: "Minimal watercolor illustration of two anonymous facing forms connected by a quiet line and gold pause point, suggesting respectful emotional reconnection.",
    prompt: `${basePrompt} Create supplementary artwork for the article "Sex Addiction: Recovery Through Emotional Connection." Show two anonymous facing forms with a wider clear space between them, separate gentle teal pathways moving toward a shared muted gold pause point, and a light curved line suggesting respectful connection. Keep fully non-explicit, calm, and non-stigmatizing.`,
    palette: sharedPalette,
    usage: "Inline artwork for the emotional-reconnection section of the CMS blog: Sex Addiction: Recovery Through Emotional Connection.",
  },
  {
