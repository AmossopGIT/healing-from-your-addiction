...
export const ANALYTICS_EVENT_ALLOWLIST = [
  ...
  "readiness_assessment_start",
  "readiness_assessment_step_complete",
  "readiness_assessment_account_gate",
  "readiness_assessment_save_attempt",
  "readiness_assessment_save_success",
  "readiness_assessment_save_error",
  "lead_form_start",
  "lead_form_submit",
